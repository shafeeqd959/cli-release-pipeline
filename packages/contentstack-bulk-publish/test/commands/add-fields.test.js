...
describe("add-fields", () => {
  ...
  beforeEach(() => {
    ...
    nock(dummyConfig.get("apiEndPoint"), {
      ...
      .get(
        `/v${dummyConfig.get("apiVersion")}/content_types/helloworld/entries`
      )
      .query({
        locale: "en-us",
        include_count: true,
    ...
    nock(dummyConfig.get("apiEndPoint"), {
      ...
      .put(
        `/v${dummyConfig.get(
          "apiVersion"
        )}/content_types/helloworld/entries/dummyEntryId?locale=en-us`
      )
    ...
    nock(dummyConfig.get("cdnEndPoint"), {
      ...
      .get(
        `/v${dummyConfig.get(
          "apiVersion"
        )}/content_types/helloworld/entries/dummyEntryId`
      )
      .query({
        locale: "ar-eg",
  ...
  test
    ...
    .catch((error) => {
      expect(error.message).to.contain(
        "Content Types, Environments are required for processing this command. Please check --help for more details"
      );
    })
