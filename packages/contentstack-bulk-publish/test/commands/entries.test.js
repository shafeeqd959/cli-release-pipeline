...
const stack = require("../../src/util/client.js").getStack({
  apikey: "dummyApiKey",
  managementTokenAlias: "dummyManagementTokenAlias",
});
  ...
  beforeEach(() => {
    ...
    nock(dummyConfig.get("apiEndPoint"), {
      ...
      .get(
        `/v${dummyConfig.get(
          "apiVersion"
        )}/content_types/dummyContentType/entries`
      )
      .query({
        include_count: true,
        skip: 0,
