...
test
  .stub(
    require("../../../src/lib/util/contentstack-management-sdk"),
    "Client",
    (e) => {
      return {
        stack: function () {
  ...
  .stub(cliux, "prompt", (_name) => async (name) => {
    ...
    if (name === message.promptMessageList.promptSourceStack)
      return "newstackUid";
    if (name === message.promptMessageList.promptPathStoredData)
      return "../contents";
  })
