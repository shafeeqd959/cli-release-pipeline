...
JsonMigrationCommand.flags = {
  ...
  "global-field": flags.boolean({
    description:
      "This flag is set to false by default. It indicates that current content type is a globalfield",
    default: false,
    required: false,
  }),
  yes: flags.boolean({
  ...
  "batch-limit": flags.integer({
    description: "Provide batch limit for updating entries",
    default: 50,
  }),
  //To be deprecated
  ...
  isGlobalField: flags.boolean({
    char: "g",
    description:
      "This flag is set to false by default. It indicates that current content-type is global-field",
    hidden: true,
